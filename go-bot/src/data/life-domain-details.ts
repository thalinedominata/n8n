...
export const lifeDomainDetails: Record<string, LifeDomainDetails> = {
	health: {
		...
		features: [
			...
			{ title: 'Care-team bridge', description: 'Shareable summaries for family and clinicians, controlled by the owner.' },
		],
		...
		stories: [
			...
			{ id: 'h2', quote: 'My patients take their medication now. Not because of alarms, but because someone friendly asks about their day at the same time.', author: 'Dr. Okafor, geriatrician' },
		],
		faq: [
	...
	business: {
		...
		features: [
			...
			{ title: 'Meeting memory', description: 'Action items captured and chased, politely and relentlessly.' },
		],
	...
	mobility: {
		overview:
			'Getting around, together. Go-Bot walks beside you at your pace, carrying, guiding, and steadying, from the front door to wherever the day leads.',
		features: [
	...
	'mental-health': {
		overview:
			'Space to breathe. Go-Bot offers gentle structure, grounding presence, and honest check-ins. He supports professionals and loved ones and never replaces them.',
		features: [
	...
	accessibility: {
		overview:
			'Ability, amplified. Designed with the disability community, not only for it: sight, hearing, mobility, and cognitive support that adapts to how you live.',
		features: [
