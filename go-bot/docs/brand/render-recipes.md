...
8. BRADY BOT - white shell, navy american-football jersey with a large number 12 on the chest, silver shoulder yokes and red piping, black long-sleeve base layer, silver game pants, a plain silver helmet with a red facemask carried under one arm. No name text on the jersey, no team crests, no league logos, no helmet decals - the number 12 is the only marking.
